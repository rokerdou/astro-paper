...
DELETE FROM posts;
DELETE FROM tags;
INSERT INTO posts (slug, title, description, body, body_html, headings, search_text, author, pub_datetime, mod_datetime, sort_datetime, featured, draft, og_image, cover_image, canonical_url, hide_edit_post, timezone, created_at, updated_at) VALUES ('astro-paper-2', 'AstroPaper 2.0', 'AstroPaper with the enhancements of Astro v2. Type-safe markdown contents, bug fixes and better dev experience etc.', '
...
', '<p>Astro 2.0 has been released with some cool features, breaking changes, DX improvements, better error overlay and so on. AstroPaper takes advantage of those cool features, especially Content Collections API.</p>
...
', '<p>We''re excited to announce the release of AstroPaper v3, packed with new features, enhancements, and bug fixes to elevate your web development experience. Let''s dive into the highlights of this release:</p>
...
', '<p>Hello everyone! Wishing you a happy New Year 🎉 and all the best for 2024! We''re excited to announce the release of AstroPaper v4, a significant update that introduces a range of new features, improvements, and bug fixes to elevate your blogging experience. A big thank you to all the contributors for their valuable input and efforts in making version 4 possible!</p>
...
', '<p>At last, the long-awaited AstroPaper v5 is finally here. AstroPaper v5 keeps the same minimal &#x26; clean look, but comes with significant updates under the hood.</p>
...
', '<p>Here are some rules/recommendations, tips &#x26; ticks for creating new posts in AstroPaper blog theme.</p>
...
', '<p>This post will explain how you can enable/disable light &#x26; dark mode for the website. Moreover, you''ll learn how you can customize color schemes of the entire website.</p>
...
', '<p>New feature in AstroPaper v1.4.0, introducing dynamic OG image generation for blog posts.</p>
...
', '<p>This document demonstrates how to use LaTeX equations in your Markdown files for AstroPaper. LaTeX is a powerful typesetting system often used for mathematical and scientific documents.</p>
...
', '<p>AstroPaper is a highly customizable Astro blog theme. With AstroPaper, you can customize everything according to your personal taste. This article will explain how you can make some customizations easily in the config file.</p>
...
```
', '<p>I''ve crafted some predefined color schemes for this AstroPaper blog theme. You can replace these color schemes with the original ones.</p>
...
</code></pre>', '[{"depth":2,"slug":"table-of-contents","text":"Table of contents"},{"depth":2,"slug":"light-color-schemes","text":"Light color schemes"},{"depth":3,"slug":"lobster","text":"Lobster"},{"depth":3,"slug":"leaf-blue","text":"Leaf Blue"},{"depth":3,"slug":"pinky-light","text":"Pinky light"},{"depth":2,"slug":"dark-color-schemes","text":"Dark color schemes"},{"depth":3,"slug":"astro-paper-1-original-dark-theme","text":"AstroPaper 1 original Dark Theme"},{"depth":3,"slug":"deep-oyster","text":"Deep Oyster"},{"depth":3,"slug":"pikky-dark","text":"Pikky dark"},{"depth":3,"slug":"astro-dark-high-contrast","text":"Astro dark (High Contrast)"},{"depth":3,"slug":"astro-dark-new-default-dark-theme-in-astro-paper-2","text":"Astro dark (New default dark theme in AstroPaper 2)"},{"depth":3,"slug":"astro-deep-purple-new-dark-theme-in-astro-paper-3","text":"Astro Deep Purple (New dark theme in AstroPaper 3)"},{"depth":3,"slug":"astro-paper-v-4-special-new-dark-theme-in-astro-paper-4","text":"AstroPaper v4 Special (New dark theme in AstroPaper 4)"}]', 'I''ve crafted some predefined color schemes for this AstroPaper blog theme. You can replace these color schemes with the original ones. If you don''t know how you can configure color schemes, check this blog post. Table of contents Light color schemes Light color scheme has to be defined using the css selector :root and html[data theme="light"]. Lobster lobster color scheme Leaf Blue leaf blue color scheme Pinky light pinky color scheme Dark color schemes Dark color scheme has to be defined as html[data theme="dark"]. AstroPaper 1 original Dark Theme AstroPaper 1 default dark theme Deep Oyster deep oyster color scheme Pikky dark pinky dark color scheme Astro dark (High Contrast) astro dark color scheme Astro dark (New default dark theme in AstroPaper 2) new dark color scheme low contrast Astro Deep Purple (New dark theme in AstroPaper 3) AstroPaper v3 new theme AstroPaper v4 Special (New dark theme in AstroPaper 4) AstroPaper v4 new theme', 'Sat Naing', '2022-09-26T12:13:24.000Z', '2024-01-04T09:09:06.000Z', '2024-01-04T09:09:06.000Z', 0, 0, NULL, 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=800&h=450&fit=crop', NULL, 0, NULL, '2026-06-02T14:28:38.480Z', '2026-06-02T14:28:38.480Z');
INSERT OR IGNORE INTO posts_tags (post_id, tag_id) SELECT posts.id, tags.id FROM posts, tags WHERE posts.slug = 'predefined-color-schemes' AND tags.slug = 'color-schemes';
INSERT INTO posts (slug, title, description, body, body_html, headings, search_text, author, pub_datetime, mod_datetime, sort_datetime, featured, draft, og_image, cover_image, canonical_url, hide_edit_post, timezone, created_at, updated_at) VALUES ('setting-dates-via-git-hooks', 'How to use Git Hooks to set Created and Modified Dates', 'How to use Git Hooks to set your Created and Modified Dates on AstroPaper', '
...
2. added `| null` to line 5 in `src/components/Datetime.tsx` so that it looks like
   ...
   ```
', '<p>In this post I will explain how to use the pre-commit Git hook to automate the input of the created (<code>pubDatetime</code>) and modified (<code>modDatetime</code>) in the AstroPaper blog theme frontmatter</p>
