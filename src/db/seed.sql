...
INSERT INTO posts (slug, title, description, body, body_html, headings, search_text, author, pub_datetime, mod_datetime, featured, draft, og_image, cover_image, canonical_url, hide_edit_post, timezone, created_at, updated_at) VALUES ('astro-paper-v5', 'AstroPaper 5.0', 'AstroPaper v5: keep the clean look, updates under the hood.', '
...
<p>rec 1</p>', '[{"depth":2,"slug":"motivation","text":"Motivation"}]', 'Users cannot see this post because it is in draft. Motivation rec 1', 'Sat Naing', '2022-06-06T04:06:31.000Z', NULL, 0, 1, NULL, NULL, NULL, 0, NULL, '2026-06-01T14:13:00.157Z', '2026-06-01T14:13:00.157Z');
